...
class AddressFormPartial extends React.Component {
  componentDidMount() {
    if (this.props.scrollTo === 'billing-address') {
      scrollTo('#billing-address', `#${this.props.addressFormModalScrollContainerId}`)
    }
  }
  ...
  render() {
    const {
      ...
      isValid,
      userLocation,
      addressFormModalScrollContainerId
    } = this.props

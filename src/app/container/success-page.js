...
const CartPage = ({offer, order}) => {
  const referralUrl = `https://3d-printing-price.all3dp.com/?utm_source=referral&utm_campaign=${order.orderNumber}`
  const SuccessSection = () => (
    <Section modifiers={['highlight']}>
      ...
      <Paragraph modifiers={['l']}>
        Through the link above, you will receive 20% commission on the total amount of the referred
        customer&apos;s first order. You can earn even more money if you refer us to additional
        friends and colleagues. The money will be credited to the account that you used to place
        this order. This offer is valid until May 31th 2018.
      </Paragraph>
